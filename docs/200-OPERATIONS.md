...
- deploying `wiki` for the public documentation site.
...
The `wiki` stack provides the public documentation site. It is published
through `nginx-public` at `wiki.victus.fit` and does not publish production
host ports directly.
