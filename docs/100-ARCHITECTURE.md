...
The `wiki` stack owns the public documentation site. Pages are edited in
Wiki.js; its PostgreSQL database is the source of truth.
...
`wiki.victus.fit` to `wiki:3000`. Its database remains on the internal
